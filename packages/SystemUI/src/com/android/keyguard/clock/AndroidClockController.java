...
/**
 * Controller for Android clock that can appear on lock screen and AOD.
 */
public class AndroidClockController implements ClockPlugin {
    ...
    /**
     * Create a AndroidClockController instance.
     *
     * @param res Resources contains title and thumbnail.
     * @param inflater Inflater used to inflate custom clock views.
     * @param colorExtractor Extracts accent color from wallpaper.
     */
    public AndroidClockController(Resources res, LayoutInflater inflater,
    ...
    private void createViews() {
        mView = (ClockLayout) mLayoutInflater.inflate(R.layout.android_clock, null);
    ...
    public String getTitle() {
        return mResources.getString(R.string.clock_title_android);
    }

    @Override
    public Bitmap getThumbnail() {
        return BitmapFactory.decodeResource(mResources, R.drawable.android_thumbnail);
    }
